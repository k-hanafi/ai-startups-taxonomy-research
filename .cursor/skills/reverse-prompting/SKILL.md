...
- Check `.cursor/experience/` for relevant prior decisions
...
Use AskQuestion or present questions directly. For each question:
...
```
Before you begin:
1. Read .cursor/experience/{domain}.md for decisions from past builds

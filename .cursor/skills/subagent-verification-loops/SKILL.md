...
Write to `~/.cursor/agent-workspace/verification/verification_report.md`:
...
- **Existing report**: Overwrite `~/.cursor/agent-workspace/verification/` — these are ephemeral.

## Output files

| File | Description |
|------|-------------|
| `~/.cursor/agent-workspace/verification/verification_report.md` | Verification report with issues and resolutions |

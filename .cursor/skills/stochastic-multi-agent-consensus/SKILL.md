...
Write to `~/.cursor/agent-workspace/consensus/consensus_report.md`:
...
- **Existing report**: Check `~/.cursor/agent-workspace/consensus/` for existing files. Overwrite without asking (these are ephemeral analysis artifacts, not persistent data).
...
| File | Description |
|------|-------------|
| `~/.cursor/agent-workspace/consensus/consensus_report.md` | Full aggregation report |
